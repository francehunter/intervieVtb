...
<img src="https://github.com/francehunter/intervieVtb/blob/main/interview/kafka-diagram.jpg" width="1000" height="200">
...
Метрики: время ответа, распределение партиций по брокерам (равномернее - лучше), частота переизбрания мастеров, лаг репликации. Программно можно достать через public Map metrics(). Обище метрики: диск, сеть. 
